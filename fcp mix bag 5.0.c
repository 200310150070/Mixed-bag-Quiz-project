...
printf("######################################################################################################################\n"); 
 ...
 { printf("in switch\n");
  ...
  { 
   ...
   if(ans=='B'|| ans=='b')
   {if(time_taken<20.00)
      { printf ("\nWell DONE! your answer is CORRECT!!\n Great you have anwered Real quick !!");
        m[0]+=5;
	  }
	  else
	  { printf ("KUDOS %s Your answer is CORRECT!!,But OOppss you were too slow.",name);
        m[0]+=2;
	  }
    }
   else
   ...
   if (ans=='D'|| ans=='d')
    {if(time_taken<20.00)
	  ...
	  { printf ("Yayy your answer is CORRECT!!,But you were really slow %s :(",name);
        m[0]+=2;
	  }
    }
   else
    ...
    printf ("\n\nQ3: Mahatma Gandhi's remark , ' A post-dated cheque on a crumbling bank' is regarding the proposal of ______\n");
...
printf ("Please enter the correct option\n");
 ...
 if (ans=='B'|| ans=='b')
 ...
 else
    {
	  ...
	  printf ("\n\nQ3: The point directly over your head is called _________ \n");
 ...
 if (ans=='C'|| ans=='c')
    ...
    if(time_taken<20.00)
	  ...
	  { printf ("Well Done your answer is CORRECT!!,but you were really slow. SPEED UP!!!");
        m[2]+=2;
	  }
    }
 else
 ...
 if (ans=='A'|| ans=='a')
    {
    if(time_taken<20.00)
      { printf ("\nWOAHOO your answer is CORRECT!!\nand you answered before the TIMEOUT!!");
        m[3]+=5;
	  }
	  else
 ...
 if (ans=='C'|| ans=='c')
   ...
   if(time_taken<20.00)
	  ...
	  { printf ("NICE your answer is CORRECT!!,but OOppss you were really slow.");
        m[3]+=2;
	  }
    }
 else
   ...
   if (ans=='B'|| ans=='b')
    {if(time_taken<20.00)
	  ...
	  { printf ("WELL DONE your answer is CORRECT!!,but you were really slow.");
        m[3]+=2;
	  }
    }
   else
